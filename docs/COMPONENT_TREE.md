# Lifetopia World — Component Tree
...
| `apps/website/components/dashboard/DashboardHeader.tsx` | `DashboardHeader` |
| `apps/website/components/dashboard/InventoryPreview.tsx` | `InventoryPreview` |
| `apps/website/components/dashboard/LatestNewsPreview.tsx` | `LatestNewsPreview` |
| `apps/website/components/dashboard/LogoutButton.tsx` | `LogoutButton` |
| `apps/website/components/dashboard/PlayerHero.tsx` | `PlayerHero` |
| `apps/website/components/dashboard/ProfileCard.tsx` | `ProfileCard` |
| `apps/website/components/dashboard/QuickActions.tsx` | `QuickActions` |
| `apps/website/components/dashboard/SettingsCard.tsx` | `SettingsCard` |
| `apps/website/components/dashboard/StatsGrid.tsx` | `StatsGrid` |
| `apps/website/components/dashboard/VerifyEmailBanner.tsx` | `VerifyEmailBanner` |
| `apps/website/components/dashboard/WalletOverview.tsx` | `WalletOverview` |
| `apps/website/components/home/account/AccountFeatureGrid.tsx` | `AccountFeatureGrid` |
| `apps/website/components/home/account/AccountPreviewCard.tsx` | `AccountPreviewCard` |
| `apps/website/components/home/account/AccountSection.tsx` | `AccountSection` |
...
| `apps/website/components/home/hero/HeroBackground.tsx` | `HeroBackground` |
| `apps/website/components/home/hero/HeroButtons.tsx` | `HeroButtons` |
| `apps/website/components/home/hero/HeroContent.tsx` | `HeroContent` |
