        ...
        <div className="-mt-16 flex flex-col gap-5 md:-mt-20 md:flex-row md:items-end">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="rounded-full border border-[#ead9b8] bg-white/80 px-3 py-1 text-xs font-black text-[#9b6635]">
                {profile.role}
              </span>

              <span className="rounded-full border border-[#dfeec9] bg-[#edf7df] px-3 py-1 text-xs font-black text-[#4f8124]">
                {profile.accountType}
              </span>
            </div>
          </div>
